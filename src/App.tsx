      ...
      <div className="background" style={{backgroundColor: randomColor, transition}}>
        <div id="quote-box">
          ...
          <div className="buttons">
            ...
            id="tweet-quote" style={{backgroundColor: randomColor, transition, marginRight: "10px"}}>
            <FaTwitter color="white"/>
            </a>
            <button id="new-quote" onClick={changeQuote} style={{backgroundColor: randomColor, transition, color: "#c3c1d4"}}>
              Change Quote
            </button>
          </div>
        </div>
